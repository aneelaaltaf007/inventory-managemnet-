...
st.subheader('This is a simple data analysis application  created by @Aneela Altaf')
...
# print the null values of these are > 0
...
#create the column to be used a hue in pairplot
